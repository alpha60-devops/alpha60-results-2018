---
layout: default
title: "Alpha60 Swarm Results 2018"
...
- Media Objects
{% capture media_objects %}{% include year-2018-0-media-objects.txt %}{% endcapture %}{{ media_objects | replace: '.md)', '.html)' }}
...
- [Year-2018 data](https://github.com/alpha60-devops/alpha60-results-2018/tree/main/data)
